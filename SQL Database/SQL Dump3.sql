...
insert  into `admin`(`id`,`username`,`password`,`name`,`jenis_kelamin`) values 
(1,'admingo','123','Raka','Laki-laki');
...
(11,170,55,'19.03','Berat Badan Anda Ideal');
...
(7,'Laki-laki',30,170,50,'11.46','Anda Kekurangan Lemak'),
(8,'Perempuan',30,170,50,'22.26','Anda Sangat Bugar');
...
CREATE TABLE `jadwal_mingguan` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `jadwal_mingguan_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `logs_in` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `jadwal_mingguan` */

insert  into `jadwal_mingguan`(`id`,`id_user`,`hari`,`waktu`,`kegiatan`) values 
(1,1,'Senin','07:00:00','Bangun'),
(2,1,'Senin','07:30:00','Makan'),
(3,1,'Senin','19:00:00','Makan'),
(4,1,'Senin','22:30:00','Tidur'),
(5,1,'Senin','16:45:00','Olahraga'),
(6,1,'Senin','13:30:00','Makan'),
(7,1,'Selasa','09:30:00','Makan'),
(8,1,'Selasa','12:00:00','Makan'),
(9,1,'Selasa','07:00:00','Bangun'),
(10,1,'Selasa','07:45:00','Olahraga'),
(11,1,'Selasa','22:30:00','Tidur'),
(12,1,'Selasa','19:00:00','Makan'),
(13,1,'Selasa','12:55:00','Makan'),
(14,1,'Selasa','11:55:00','Olahraga'),
(15,1,'Selasa','12:10:00','Makan'),
(16,1,'Selasa','12:25:00','Bangun'),
(17,1,'Selasa','12:35:00','Bangun'),
(18,7,'Selasa','13:00:00','Bangun'),
(19,7,'Senin','06:30:00','Bangun'),
(20,8,'Selasa','10:30:00','Makan'),
(21,8,'Selasa','08:00:00','Bangun');
...
insert  into `logs_in`(`id`,`username`,`password`,`name`,`usia`,`jenis_kelamin`,`tinggi`,`berat`) values 
(1,'hinata','123','shoyo',22,'Laki-laki',160,40),
(2,'adi','123','gusmang',18,'Laki-laki',168,65),
(3,'gusmang','456','Adi',25,'Laki-laki',170,55),
(4,'prayista','123','gasmung',19,'Laki-laki',165,70),
(5,'tsukki','123','sima',30,'Perempuan',172,64),
(6,'kamado','123','tanjiro',19,'Laki-laki',170,50),
(7,'kin','123','kareem',24,'Laki-laki',170,60),
(8,'richad','123','richad',30,'Laki-laki',170,50);
